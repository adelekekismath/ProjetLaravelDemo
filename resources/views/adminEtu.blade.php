...
<body>
    <nav class="light-blue lighten-1" role="navigation">
      ...
      <div class="section no-pad-bot" id="index-banner">
        <div class="container">
          <br><br>
          <h1 class="header center orange-text">Bienvenu sur votre espace d'etudiant</h1>
          <div class="row center">
            <h5 class="header col s12 light">Vous pouvez gerer votre profil et vos notes ici</h5>
          </div>
          <div class="row center">
